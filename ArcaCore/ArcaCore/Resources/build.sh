...
#
#Created by Adrian Kemp on 2013-12-15
# Build Phase
#   Here we are building the framework's static library for all of the required architectures
 
xcodebuild -target "ArcaCore" -arch x86_64 -sdk iphonesimulator install
xcodebuild -target "ArcaCore" -arch i386 -sdk iphonesimulator install
xcodebuild -target "ArcaCore" -arch armv7 install
xcodebuild -target "ArcaCore" -arch armv7s install
