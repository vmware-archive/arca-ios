...
#
#Created by Adrian Kemp on 2013-10-18
# Build Phase
#   Here we are building the framework's static library for all of the required architectures
 
xcodebuild -target "ArcaSync" -arch i386 -sdk iphonesimulator install
xcodebuild -target "ArcaSync" -arch armv7 install
xcodebuild -target "ArcaSync" -arch armv7s install
